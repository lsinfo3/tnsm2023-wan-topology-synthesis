...
for metric in metrics:
    ...
    for numbins in np.flip([1,2,4, 8, 16, 32, 64, 128]):
        ...
        #         with open(path +"synth_sample_2K_"+str(k)+"_.pkl","rb") as f:
                ...
                with open("sampling_gan/synth_sample_"+str(k)+"_"+str(s)+"_GAN_"+metric+"_b"+str(numbins)+".pkl","wb") as f:
        ...
        graph_metrics_df.to_csv("graph_metrics_node_"+metric+"_sampling_"+name+"_GAN_"+str(numbins)+".csv",index=False,sep=";")
